...
public class ShopScreen2 {
    ...
    public ShopScreen2() {
        ...
        buyRacketButton.addActionListener(e -> {
            statusLabel.setText(shopManager.buy(racket));
        }); // Lambda expression to simplify boilerplate

        buyspeedPotionButton.addActionListener(e -> {
            statusLabel.setText(shopManager.buy(speedPotion));
        }); // Lambda expression to simplify boilerplate

        buypowerPotionButton.addActionListener(e -> {
            statusLabel.setText(shopManager.buy(powerPotion));
        }); // Lambda expression to simplify boilerplate
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ShopScreen2());
    }
}
